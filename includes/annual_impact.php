...
function st_annual_impact_initiatives($page_views,$carbon_footprint) 
{
    ...
    $kwh_energy = number_format(($annual_carbon_footprint / 0.233),3); // Umrechnung von kg CO₂ in kWh (Beispielwert)
...
?>
      <div class="st-box">
                ...
                <div class="inside">
                    ...
                    <p><strong style="color:red;"><?php echo $kwh_energy; ?></strong> kWh of energy,that’s enough electricity to drive an electric car <strong style="color:red;"><?php echo $electric_car_distance; ?> </strong>km.<sub style="color:grey;"> (1 kWh reicht für 5 km)</sub</p>
                </div>
            </div>
<?php
    return ob_get_clean();
