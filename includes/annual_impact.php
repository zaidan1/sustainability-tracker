...
function st_annual_impact_initiatives($page_views,$carbon_footprint) 
{
    ...
    $kwh_energy_formatted = number_format($kwh_energy, 2);
    $electric_car_distance_formatted = number_format($electric_car_distance, 2);
?>
      <div class="st-box">
                <h2 class="hndle"><span>Annual Impact</span></h2>
                <div class="inside">
                    <p>Over a year, <strong style="color:red;"><?php echo $annual_page_views; ?></strong> is the avarage page views, produces <strong style="color:red;"><?php echo $annual_carbon_footprint; ?></strong> kg of  CO₂ equivalent.</p>
                    ...
                    <p><strong style="color:red;"><?php echo $kwh_energy_formatted; ?></strong> kWh of energy,that’s enough electricity to drive an electric car <strong style="color:red;"><?php echo $electric_car_distance_formatted; ?> </strong>km.<sub style="color:grey;"> (1 kWh reicht für 5 km)</sub</p>
                </div>
            </div>
<?php
    return ob_get_clean();
