...
function st_carbon_footprint_calculator($page_views) 
{
    ...
    ?>
     <div class="st-box">
                ...
                <p for="page-views">Monthly Page Views: <strong><?php echo $page_views; ?></strong></p>
                <form id="st-carbon-footprint-form" method="post" action="">
                    <table>
                      <tr>
                        <td>
                          <input type="number" id="page-views" name="page_views" value="<?php echo $page_views; ?>" required>
                        </td>
                        <td>
