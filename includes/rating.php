...
function rating($page_views,$carbon_footprint,$carbon_offset,$rating) 
{
    ...
    ?>
     <div class="st-dashboard">
            ...
            <div class="st-box">
                <h2>Overview</h2>
                <p><strong>Monthly Page Views:</strong> <?php echo esc_html($page_views); ?></p>
                <p><strong>Total Carbon Footprint:</strong> <?php echo number_format($carbon_footprint,3); ?> kg  CO₂</p>
                <p><strong>Carbon Offset:</strong> <?php echo number_format($carbon_offset,3); ?> $<sub style="color: gray;"> $10 per ton of CO2 offset (1000 kg)</sub></p>
                <p><strong>Rating:</strong></p>
                <div class="rating-system">
                    <div class="rating-header">
                        <h2>Hurrah! This web page achieves a carbon rating of <span id="carbon-rating"><?php echo esc_html($rating); ?></span></h2>
                    </div>
